...
fun GrupoFormScreen(
    ...
    viewModel: GrupoFormViewModel = viewModel(),
    onBack: () -> Unit = {},
...
*/
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(if (uiState.isEditMode) "Editar grupo" else "Nuevo grupo") },
                navigationIcon = {
        ...
        Column(
            ...
            CampeonatoDropdown(
                ...
                onCampeonatoSelected = viewModel::onCampeonatoSelected,
            ...
            OutlinedTextField(
                value = uiState.formData.codigoProvincia,
                onValueChange = viewModel::onCodigoProvinciaChange,
...
private fun CampeonatoDropdown(
    ...
    onCampeonatoSelected: (String) -> Unit,
    showError: Boolean
) {
        ...
        ExposedDropdownMenu(expanded = expanded, onDismissRequest = { expanded = false }) {
            campeonatos.forEach { campeonato ->
                androidx.compose.material3.DropdownMenuItem(
                    ...
                    onClick = {
                        onCampeonatoSelected(campeonato.CODIGO)
                        expanded = false
                    }
                )
            }
